...
class ProductFilterRequest {
  ...
  ProductFilterRequest({
    ...
    this.page = 0, // Backend thường xử lý trang từ 0, trong khi cURL gửi 1. Cần xác nhận lại.
    this.pageSize = 20,
  });
  ...
  Map<String, dynamic> toJson() {
    ...
    if (fromDate != null) data['fromDate'] = DateFormat('yyyy-MM-dd HH:mm:ss').format(fromDate!);
    if (toDate != null) data['toDate'] = DateFormat('yyyy-MM-dd HH:mm:ss').format(toDate!);
